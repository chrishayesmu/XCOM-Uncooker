...
2. Download the latest [XCOM Uncooker release](https://github.com/chrishayesmu/XCOM-Uncooker/releases/latest) and unzip it. It should contain folders called `xcom-uncooker` and `replacement-packages`, and a file called `xcom-uncooker-udk-setup.exe`.
